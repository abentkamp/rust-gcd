...
/- [gcd::euclid_u16]: loop 0:
   Source: 'src/lib.rs', lines 75:12-82:13 -/
def euclid_u16_loop (a : U16) (b : U16) : Result U16 :=
  if b != 0#u16
  then do
       let b1 ← a % b
       euclid_u16_loop b b1
  else ok a
partial_fixpoint
...
def euclid_u16 (a : U16) (b : U16) : Result U16 :=
  ...
  euclid_u16_loop a1 b1

/- [gcd::euclid_u32]: loop 0:
   Source: 'src/lib.rs', lines 75:12-82:13 -/
def euclid_u32_loop (a : U32) (b : U32) : Result U32 :=
  if b != 0#u32
  then do
       let b1 ← a % b
       euclid_u32_loop b b1
  else ok a
partial_fixpoint
...
def euclid_u32 (a : U32) (b : U32) : Result U32 :=
  ...
  euclid_u32_loop a1 b1

/- [gcd::euclid_u64]: loop 0:
   Source: 'src/lib.rs', lines 75:12-82:13 -/
def euclid_u64_loop (a : U64) (b : U64) : Result U64 :=
  if b != 0#u64
  then do
       let b1 ← a % b
       euclid_u64_loop b b1
  else ok a
partial_fixpoint
...
def euclid_u64 (a : U64) (b : U64) : Result U64 :=
  ...
  euclid_u64_loop a1 b1

/- [gcd::euclid_u128]: loop 0:
   Source: 'src/lib.rs', lines 75:12-82:13 -/
def euclid_u128_loop (a : U128) (b : U128) : Result U128 :=
  if b != 0#u128
  then do
       let b1 ← a % b
       euclid_u128_loop b b1
  else ok a
partial_fixpoint
...
def euclid_u128 (a : U128) (b : U128) : Result U128 :=
  ...
  euclid_u128_loop a1 b1

/- [gcd::euclid_usize]: loop 0:
   Source: 'src/lib.rs', lines 75:12-82:13 -/
def euclid_usize_loop (a : Usize) (b : Usize) : Result Usize :=
  if b != 0#usize
  then do
       let b1 ← a % b
       euclid_usize_loop b b1
  else ok a
partial_fixpoint
